                    ...
                    <div   class="d-flex justify-content-between">
                        ...
                        <div>
                            <form action="{{ route('profileimage.update') }}" method="post" enctype="multipart/form-data">
                                ...
                                <input type="submit" value="Upload Profile" class="btn btn-info">
            ...
            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 mb-30">
                <div class="pd-20 card-box height-100-p">
                    <div class="profile-photo">
                        ...
                        <img
                            src="{{ asset('storage/userprofile/' . Auth::user()->image) }}"
                            alt=""
                            class="avatar-photo"
                        />
                       {{--  --}}
                                ...
                                <div class="modal-content">
                                    <div class="modal-body pd-5">
                                        <div class="img-container">
                                            <img
                                                id="image"
                                                src="{{ asset('ui/backend') }}/vendors/images/photo2.jpg"
                                                alt="Picture"
                                            />
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        >
                                                            <input
                                                                type="checkbox"
                                                                class="custom-control-input"
                                                                id="customCheck1-1" name="checkbox"
                                                            />
                                                            <label
                                                                class="custom-control-label weight-400"
                                                                for="customCheck1-1"
