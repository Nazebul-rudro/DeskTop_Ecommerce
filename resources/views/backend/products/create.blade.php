        ...
        <form method="post" action="{{ route('products.store') }}" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-12 col-md-10">
                    <input class="form-control" type="text" placeholder="Enter Product Name" name="ProductName"  id="ProductName" value="{{ old('ProductName') }}">
                    <div class="my-2">
                        @error('ProductName')
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-12 col-md-10">
                    <input class="form-control" type="text" placeholder="Enter Product Code" name="ProductCode" id="ProductCode" value="{{ old('ProductName') }}">
                    <div class="my-2">
                        @error('ProductCode')
                            <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-12 col-md-10">
                    <input class="form-control" type="number" placeholder="Enter Product Price" name="ProductPrice" id="ProductPrice" value="{{ old('ProductPrice') }}">
                    <div class="my-2">
                        @error('ProductPrice')
                            <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-12 col-md-10">
                    <input class="form-control" type="number" placeholder="Enter Discount Price" name="DiscountPrice" id="DiscountPrice" value="{{ old('DiscountPrice') }}">
                    <div class="my-2">
                        @error('DiscountPrice')
                            <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-12 col-md-10">
                    <input class="form-control" type="number" placeholder="Enter After Discount Price" name="AfterDiscount" id="AfterDiscount" value="{{ old('AfterDiscount') }}">
                    <div class="my-2">
                        @error('AfterDiscount')
                            <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-12 col-md-10">
                    <textarea name="ShortDescription" id="ShortDescription" cols="30" rows="10" class="form-control" placeholder="Somethig Writing........">{{ old('ShortDescription') }}</textarea>
                    <div class="my-2">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-12 col-md-10">
                    <textarea name="LongDescription" id="LongDescription" cols="30" rows="10" class="form-control" placeholder="Somethig Writing........">{{ old('LongDescription') }}</textarea>
                    <div class="my-2">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-12 col-md-10">
                    <input class="form-control" type="number" placeholder="Enter Product Quantity" name="ProductQuantity" id="ProductQuantity" value="{{ old('ProductQuantity') }}">
                    <div class="my-2">
