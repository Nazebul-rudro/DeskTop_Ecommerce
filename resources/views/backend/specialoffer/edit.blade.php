<x-backend.layouts.master>
    ...
    {{-- {{dd('calling');}} --}}
    <div class="mx-2">
        <form method="post" action="{{ route('specialoffer.update', ['specialoffer'=>$specialoffer->id]) }}" enctype="multipart/form-data">
            @csrf
            @method('patch')
            <div class="form-group row">
                ...
                <div class="col-sm-12 col-md-10">
                    <input class="form-control" type="text" placeholder="Enter Category Name" name="OfferName"
                        value="{{ old('OfferName', $specialoffer->OfferName) }}" id="OfferName">
                    <div class="my-2">
                        @error('OfferName')
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-12 col-md-10">
                    <input type="number" name="OfferDiscount" id="OfferDiscount" class="form-control"
                        placeholder="Enter discount price" value="{{ old('OfferDiscount',$specialoffer->OfferDiscount) }}">
                    <div class="my-2">
                        @error('OfferDiscount')
                            <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
