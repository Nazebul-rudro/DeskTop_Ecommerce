        ...
        <table class="data-table table nowrap">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><img src="{{  asset('storage/slider/' . $slider->SliderImage) }}" alt="not Fount" srcset=""  style="height: 40px; width:80px;"></td>
                    <td>
                        <div class="table-actions">
                            <a href="{{ route('slider.restore', ['slider'=>$slider->id]) }}" data-color="#265ed7"><i class="bi bi-arrow-clockwise"></i></a>
                            <form action="{{ route('slider.delete', ['slider'=>$slider->id]) }}" method="post" style="display: inline" class="ml-3">
                              @method('delete')
                              @csrf
